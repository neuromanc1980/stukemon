...
@NamedQueries({
    ...
    @NamedQuery(name = "Trainer.ranking", query = "SELECT t FROM Trainer t ORDER BY t.points desc"),
...
public class Trainer implements Serializable {
    ...
    public Trainer(String name, int pokeballs, int potions, int points) {
        this.name = name;        this.pokeballs = pokeballs;
        this.potions = potions;        this.points = points;    }
